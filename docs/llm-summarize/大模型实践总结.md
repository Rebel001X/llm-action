> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/GPU工作原理]] [[llm-train/README]] [[llm-inference/README]] [[llm-train/peft/PEFT-API]]
> 📖 导读：作者基于 3 台 A800/H800 集群的大模型实践总结，纵览 AI 集群与集群通信、大模型训练与参数高效微调、推理加速、评估及生态等全栈技术；适合想快速建立大模型工程全景认知、了解多机多卡训练落地经验时通读。
