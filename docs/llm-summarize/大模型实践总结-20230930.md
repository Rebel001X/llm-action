> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/GPU工作原理]] [[ai-infra/网络/集合通信原语]] [[llm-train/README]] [[llm-inference/README]]
> 📖 导读：作者对大模型全栈实践的季度总结，覆盖 AI 集群/集群通信、训练、推理加速、评估、应用开发、AI 编译器与生态；适合想系统建立大模型工程全景认知、快速摸清各技术板块脉络时通读。
