...
## OPT-175B是如何炼成的
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-framework/megatron-lm/README]] [[ai-framework/deepspeed/README]] [[llm-train/README]] [[llm-eval/llm-performance/大模型场景下训练和推理性能指标名词解释]]
> 📖 导读：Meta OPT-175B 千卡训练的一线踩坑实录——数值稳定性、超参崩溃、硬件故障与试错经验；适合做大模型分布式训练前看的"避坑读物"。
