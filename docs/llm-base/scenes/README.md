> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-algo/transformer/模型架构]] [[llm-inference/解码策略]] [[llm-eval/README]] [[llm-train/README]]
> 📖 导读：这篇大文档汇总了 NLP/CV/多模态等各类 AI 任务场景的清单与定义（句子嵌入、文本排序、命名实体识别、文本生成、零样本分类、对话状态跟踪等），适合在选型任务类型、梳理大模型应用场景全景或对照任务定义时速查。
