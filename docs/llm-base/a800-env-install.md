...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/GPU工作原理]] [[ai-infra/ai-hardware/硬件对比]] [[ai-infra/网络/InfiniBand]] [[ai-framework/deepspeed/README]]
> 📖 导读：A800 八卡服务器从零搭建大模型训练/推理环境的实操手册（GCC 升级、GPU 驱动、GPUDirect 通信矩阵、CUDA 等）；适合拿到裸机准备部署训练集群、排查 GPU 拓扑与驱动问题时对照查阅。
