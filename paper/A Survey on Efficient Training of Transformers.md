...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/README]] [[ai-framework/deepspeed/README]] [[ai-framework/megatron-lm/README]] [[llm-algo/transformer/模型架构]]
> 📖 导读：这是一篇关于 Transformer 高效训练的综述，系统梳理优化器/初始化/稀疏化/混合精度/分布式并行等加速训练手段；适合在系统性了解大模型训练加速全景、或为训练框架选型与调优找思路时阅读。
