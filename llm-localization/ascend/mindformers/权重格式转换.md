...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[ai-framework/megatron-lm/README]] [[llm-compression/quantization/fp8]] [[ai-infra/ai-hardware/AI芯片软件生态]]
> 📖 导读：本文讲解昇腾 MindFormers 框架下的模型权重格式转换（PyTorch↔MindSpore 互转、分布式离线 ckpt 切分合并），适合在昇腾 NPU 上迁移/部署大模型、需要打通 HuggingFace 权重与 MindSpore 训练推理时查阅。
