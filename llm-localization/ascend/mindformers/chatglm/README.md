...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[ai-infra/ai-hardware/AI芯片软件生态]] [[ai-infra/网络/集合通信原语]] [[llm-train/README]]
> 📖 导读：本文是在昇腾 Ascend NPU 上用 MindFormers 框架做 ChatGLM-6B 全量微调与分布式训练的实操指南（含 HCCL RANK_TABLE_FILE 生成、yaml 配置、多卡启动），适合做国产芯片大模型训练落地时查阅。
