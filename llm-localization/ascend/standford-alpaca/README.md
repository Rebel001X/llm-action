...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[llm-train/README]] [[llm-alignment/RLHF]]
> 📖 导读：在昇腾 NPU 上用 Stanford Alpaca 框架对 Qwen1.5 做指令微调的实操记录（含模型下载、torchrun 多卡训练命令与参数），适合做国产卡微调落地与踩坑参考时看。
