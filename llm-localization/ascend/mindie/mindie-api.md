...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-inference/README]] [[ai-infra/算力/昇腾NPU]] [[ai-infra/ai-hardware/AI芯片软件生态]] [[llm-inference/解码策略]]
> 📖 导读：本文汇总昇腾 MindIE 推理服务的对外 API 调用示例（OpenAI 兼容接口、chat/completions 请求格式与参数），适合在昇腾 NPU 上部署大模型推理服务、需要查阅接口调用方式时速查。
