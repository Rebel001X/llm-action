# README
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[ai-infra/ai-hardware/AI芯片软件生态]] [[llm-inference/README]] [[llm-compression/quantization/量化基础]]
> 📖 导读：华为昇腾 MindIE 1.0 官方部署文档，讲在 NPU 上跑大模型推理的统一脚本、权重路径与量化配置（W8A8/W8A16/稀疏量化）；适合在昇腾平台落地大模型推理、做权重量化与精度配置时查阅。
