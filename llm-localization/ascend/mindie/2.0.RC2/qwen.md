# README
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[llm-inference/README]] [[llm-compression/quantization/量化基础]] [[llm-algo/moe/README]]
> 📖 导读：本篇是昇腾 MindIE 2.0.RC2 上 Qwen 系列（Qwen2/2.5）大模型的部署落地文档，汇总各版本在 800I A2 / 300I DUO 上的特性矩阵（张量并行、Flash/Paged Attention、W8A8/W8A16/KV cache/MoE 量化等）与权重链接；适合在国产 NPU 上跑通或调优 Qwen 推理服务时查阅。
