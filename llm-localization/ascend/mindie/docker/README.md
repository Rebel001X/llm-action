...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[ai-infra/ai-hardware/AI芯片软件生态]] [[llm-inference/README]]
> 📖 导读：这篇文档讲在华为昇腾 Ascend 平台上用 MindIE 镜像跑大模型推理服务的 Docker 实操命令（拉取/commit/run/save 镜像、挂载 NPU 设备与驱动）；适合在 800I-A2 等昇腾机器上做国产化推理部署落地时查阅。
