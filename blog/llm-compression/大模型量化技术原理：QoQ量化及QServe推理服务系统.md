> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-compression/quantization/量化基础]] [[llm-compression/quantization/GPTQ]] [[llm-compression/quantization/fp8]] [[llm-optimizer/kv-cache]]
> 📖 导读：本文讲解 MIT HAN Lab 的 W4A8KV4 量化方案 QoQ（渐进式分组量化 + SmoothAttention）及配套的 QServe 推理服务系统；适合在调研低比特权重/激活/KV 量化与高吞吐推理系统落地时阅读。
