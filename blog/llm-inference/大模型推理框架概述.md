...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-inference/README]] [[llm-inference/vllm/README]] [[llm-optimizer/kv-cache]] [[llm-inference/解码策略]]
> 📖 导读：盘点 vLLM、TGI、FasterTransformer 等业界主流大模型推理框架的特性与对比；适合做推理框架选型、横向了解各框架定位时通读。
