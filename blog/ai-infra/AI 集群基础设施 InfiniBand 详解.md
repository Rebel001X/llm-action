...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/网络/InfiniBand]] [[ai-infra/网络/集合通信原语]] [[ai-infra/算力/GPU工作原理]] [[ai-framework/megatron-lm/README]]
> 📖 导读：本文系统讲解 AI 集群分布式训练中的通信软硬件（PCIe/NVLink/RDMA）、NCCL 集合通信库与 InfiniBand 网络协议及其在 AI 框架中的应用；适合搭建/调优大模型训练集群网络、理解通信瓶颈时通读。
