...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/ai-hardware/硬件对比]] [[ai-infra/网络/InfiniBand]] [[ai-framework/deepspeed/README]] [[ai-infra/算力/GPU工作原理]]
> 📖 导读：本文从硬盘发展史讲到 NVMe 技术原理（总线/协议/物理接口三要素、GPUDirect Storage），并落到 AI 服务器与 DeepSpeed 的存储应用；适合在排查 I/O 瓶颈、选型 AI 集群存储或了解 NVMe-oF 时通读。
