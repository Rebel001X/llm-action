...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[ai-framework/megatron-lm/README]] [[ai-infra/网络/集合通信原语]] [[llm-train/README]]
> 📖 导读：本文讲在昇腾 910 NPU 上用 MindSpore / PyTorch 框架对 LLaMA-13B 做双机 16 卡多机多卡分布式训练的完整流程（数据转换、环境配置、并行策略），适合做大模型国产化算力适配、跨机分布式训练落地时参考。
