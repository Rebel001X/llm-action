> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-infra/算力/昇腾NPU]] [[ai-infra/ai-hardware/AI芯片软件生态]] [[ai-infra/ai-hardware/硬件对比]] [[ai-infra/算力/GPU工作原理]]
> 📖 导读：本文自底向上梳理华为昇腾AI全栈（Atlas硬件→CANN异构计算→MindSpore框架→应用使能），适合做大模型国产化算力适配选型、对标英伟达CUDA生态时参考。
