...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/peft/PEFT-API]] [[llm-algo/transformer/模型架构]] [[llm-train/README]] [[llm-compression/quantization/量化基础]]
> 📖 导读：PEFT 系列综述第一篇，从全量微调成本痛点切入，回顾 Transformer 架构基础并总览各类参数高效微调方法；适合在系统学习 LoRA/Adapter/Prompt Tuning 等具体技术前，建立全局背景认知时阅读。
