...
# Stanford Alpaca
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/README]] [[ai-framework/deepspeed/README]] [[llm-alignment/RLHF]] [[ai-framework/huggingface-peft/README]]
> 📖 本文导读：基于 LLaMA + DeepSpeed 对 Stanford Alpaca 做指令微调(SFT)的实操记录，含 torchrun/deepspeed 启动命令与训练配置，适合上手指令数据全量微调时参考。
