...
# Microsoft Megatron-DeepSpeed 训练实践
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/megatron-deepspeed/README]] [[ai-framework/deepspeed/README]] [[ai-framework/megatron-lm/README]] [[B07:llm-inference/大模型推理张量并行]]
> 📖 本文导读：基于微软 Megatron-DeepSpeed 的 GPT-3/LLaMA 预训练实操记录，涵盖 ZeRO Stage 1、Megatron 张量并行 + DeepSpeed 流水线并行的 3D 并行、Flash Attention、RoPE 以及 DeepSpeed↔Megatron 检查点转换；适合落地复现大模型预训练与并行调优时查阅。
