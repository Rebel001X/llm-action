...
# Megatron-DeepSpeed（Microsoft）项目结构
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/megatron-deepspeed/README]] [[ai-framework/megatron-lm/README]] [[ai-framework/deepspeed/README]] [[llm-train/megatron/README]]
> 📖 本文导读：本文以完整目录树的形式列出 Microsoft Megatron-DeepSpeed 仓库的项目结构（dataset/docs/examples/megatron/tools 等各级文件与脚本），适合在通读源码、定位训练/预处理脚本或了解仓库整体布局时作为速查地图。
