...
### 单机单卡
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/megatron/README]] [[ai-framework/megatron-lm/README]] [[ai-infra/网络/集合通信原语]] [[B07:llm-inference/大模型推理张量并行]]
> 📖 本文导读：Megatron-LM 训练 GPT2 的实操日志，覆盖单机单卡/单机多卡/多机多卡下张量并行、流水线并行与数据并行的启动命令与完整运行输出，适合上手 Megatron 分布式训练、对照参数与日志排查问题时查阅。
