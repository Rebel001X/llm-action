...
## 数据下载
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/megatron/README]] [[ai-framework/megatron-lm/README]] [[llm-train/README]]
> 📖 本文导读：Megatron GPT2 训练前的数据预处理实操——从数据下载、LSH 去重（cMinhash 编译踩坑修复）到生成训练用 json/shuf 清洗，适合准备 Megatron 预训练数据时按步对照操作。
