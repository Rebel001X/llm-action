...
## 项目结构
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/megatron/README]] [[ai-framework/megatron-lm/README]] [[llm-train/README]] [[ai-framework/deepspeed/README]]
> 📖 本文导读：逐目录拆解 Megatron-LM 源码工程结构（核心 megatron/、预训练脚本、tasks/tools 等），适合上手阅读 Megatron 代码、定位张量/流水线并行实现位置时按图索骥。
