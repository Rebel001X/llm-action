...
> 目标：能自己推出 **L1 分布无损**、能算 $\alpha$、能判断"这笔买卖赚不赚"。
...
| SpecDecode-Bench（MLSys 2026） | https://arxiv.org/abs/2601.11580 （v1 2025-12-31 / **v2 2026-03-18**）+ https://specdecode-bench.github.io/ | MLSys 2026，最佳论文荣誉提名 | 2026 年数据最扎实的一份基准。**⚠️ 必须读 v2 或走 `abs/`：树验证一节只在 v2 里，本库曾因写死 `…v1` 而误判网站摘要造假（2026-08-22 已更正）** | 未表态 |
