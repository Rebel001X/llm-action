...
- `_lab/test_tree.py::test_chain_beats_tree_at_small_budget`、`::test_tree_beats_chain_at_large_budget`、`::test_width_is_worthless_without_marginal_coverage` —— §3.5 的依据：最优形状随预算与边际覆盖率增益改变，**静态树一定在某些位置上是错的**。
- 可复跑：
