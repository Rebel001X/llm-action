> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/README]] [[llm-inference/README]] [[llm-compression/README]] [[ai-framework/megatron-lm/README]]
> 📖 导读：llm-action 仓库总入口与目录，全景串联 LLM 训练/微调/分布式并行/对齐/推理/压缩/测评/数据工程等实战专题；适合作为知识地图的总览页、快速跳转到各子主题时查阅。
