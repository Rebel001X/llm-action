> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-framework/deepspeed/README]] [[ai-framework/pytorch/README]] [[llm-train/README]] [[ai-infra/网络/集合通信原语]]
> 📖 导读：手把手把一个小型 CIFAR-10 图像分类模型从原始 PyTorch 改造为 DeepSpeed 分布式训练的入门实战，适合初学 DeepSpeed、想跑通端到端分布式训练第一个例子时阅读。
