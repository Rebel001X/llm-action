...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-framework/pytorch/README]] [[llm-compression/quantization/fp8]] [[llm-train/README]] [[ai-infra/算力/GPU工作原理]]
> 📖 导读：本文给出在 NVIDIA Transformer Engine 容器中跑通 MNIST 示例（含 FP8 训练）的实操步骤与训练日志，适合想动手验证 TE/FP8 混合精度训练环境的读者参考。
