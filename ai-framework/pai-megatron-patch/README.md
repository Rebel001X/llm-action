...
# 环境准备
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-framework/megatron-lm/README]] [[ai-framework/deepspeed/README]] [[llm-train/README]] [[llm-algo/moe/README]]
> 📖 导读：阿里 Pai-Megatron-Patch 大模型训练实战补丁，涵盖数据准备、HuggingFace↔Megatron 格式转换、继续预训练/SFT 与离线推理；适合用 Megatron-LM 体系做国产大模型分布式训练落地时查阅。
