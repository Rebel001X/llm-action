...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-framework/megatron-lm/README]] [[llm-compression/quantization/fp8]] [[llm-inference/README]] [[llm-eval/llm-performance/大模型场景下训练和推理性能指标名词解释]]
> 📖 导读：本文记录在 A800 上用 FasterTransformer 跑 Megatron GPT-2（345M）的实操日志，含 ckpt 转换、配置更新与 FP16/FP8 性能对比；适合需要复现 FasterTransformer 推理流程、对照 FP8 加速效果时查阅。
