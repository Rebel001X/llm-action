...
##  ZeroQuant
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-compression/quantization/量化基础]] [[llm-compression/quantization/GPTQ]] [[llm-compression/README]] [[ai-framework/deepspeed/README]]
> 📖 导读：本文讲微软提出的 ZeroQuant 训练后量化方法（细粒度分组权重量化 + 按token激活量化 + 逐层知识蒸馏LKD + 优化推理后端），适合想低成本把大模型权重/激活压到 INT8/INT4 并加速推理时阅读。
