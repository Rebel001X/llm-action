...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-compression/quantization/量化基础]] [[llm-compression/quantization/GPTQ]] [[llm-compression/quantization/fp8]] [[llm-compression/README]]
> 📖 导读：ZeroQuant(4+2) 提出用 FP6（4+2 设计）替代 INT4 量化，扩大评估范围到代码生成与摘要等生成任务，证明 FP6 精度可媲美全精度且延迟接近 INT4；适合研究低比特权重量化方案选型与硬件加速权衡时阅读。
