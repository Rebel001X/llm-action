...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-compression/quantization/量化基础]] [[llm-compression/quantization/fp8]] [[llm-compression/README]] [[llm-inference/README]]
> 📖 导读：本文介绍 FP6-LLM（TC-FPx 内核）——首个为任意位宽浮点权重提供统一 Tensor Core 支持的全栈 GPU 内核方案，单卡跑 LLaMA-70b 推理、吞吐量较 FP16 提升 1.69×–2.65×；适合研究低位浮点量化与 GPU 内核协同设计时阅读。
