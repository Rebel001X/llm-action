...
> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[ai-framework/pytorch/README]] [[ai-infra/ai-hardware/AI芯片软件生态]] [[ai-infra/算力/GPU工作原理]] [[llm-optimizer/FlashAttention]]
> 📖 导读：本文梳理 AI 编译器全景（树模型编译器 Treelite、深度学习编译器前/后端优化、计算图与算子融合等），适合在了解模型如何从框架 IR 编译到硬件、做编译优化与算子调优时阅读。
