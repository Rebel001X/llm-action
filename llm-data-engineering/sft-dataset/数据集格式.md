> 📍 导航：[[00-知识地图]]
> 🔗 相关：[[llm-train/README]] [[llm-train/peft/PEFT-API]] [[llm-alignment/RLHF]] [[llm-alignment/DPO]]
> 📖 导读：汇总主流 SFT 指令微调数据集格式（Alpaca、FastChat/Vicuna 等）的字段结构与转换示例；准备/对齐监督微调训练数据时查阅。
